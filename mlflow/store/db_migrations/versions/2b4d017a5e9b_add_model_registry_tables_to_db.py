...
def upgrade():
    ...
    op.create_table(
        ...
        Column("name", String(250), unique=True, nullable=False),
    ...
    op.create_table(
        ...
        Column("name", String(250), ForeignKey("registered_models.name", onupdate="cascade")),
        Column("version", Integer, nullable=False),
        Column("creation_time", BigInteger, default=lambda: int(time.time() * 1000)),
        Column("last_updated_time", BigInteger, nullable=True, default=None),
        Column("description", String(5000), nullable=True),
        Column("user_id", String(250), nullable=True, default=None),
