...
class SqlExperiment(Base):
    ...
    """
    Experiment name: `String` (limit 250 characters). Defined as *Unique* and *Non null* in
                     table schema.
    """
    artifact_location = Column(String(250), nullable=True)
    """
    Default artifact location for this experiment: `String` (limit 250 characters). Defined as
...
class SqlRun(Base):
    ...
    """
    user_id = Column(String(250), nullable=True, default=None)
    """
    User ID: `String` (limit 250 characters). Defaults to ``null``.
    """
